...
local on_attach = function(client, bufnr)
	...
	keymap.set("n", "<leader>se", "<cmd>Lspsaga show_buf_diagnostics<CR>", opts)
	...
	keymap.set("n", "[e", "<cmd>Lspsaga diagnostic_jump_prev<CR>", opts) -- jump to next diagnostic in buffer
